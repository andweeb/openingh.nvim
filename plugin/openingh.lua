...
vim.api.nvim_create_user_command("OpenInGHFileDefaultBranch", function(opts)
  local url

  local branch = opts.fargs[1]
  if opts.range == 0 then -- Nothing was selected
    url = openingh.get_file_url(openingh.priority.DEFAULT, branch)
  else -- Current line or block was selected
    url = openingh.get_file_url(openingh.priority.DEFAULT, branch, opts.line1, opts.line2)
  end
...
vim.api.nvim_create_user_command("OpenInGHFileLinesDefaultBranch", function(opts)
  local url

  local branch = opts.fargs[1]
  if opts.range == 0 then -- Nothing was selected
    url = openingh.get_file_url(openingh.priority.DEFAULT, branch, opts.line1)
  else -- Current line or block was selected
    url = openingh.get_file_url(openingh.priority.DEFAULT, branch, opts.line1, opts.line2)
  end
